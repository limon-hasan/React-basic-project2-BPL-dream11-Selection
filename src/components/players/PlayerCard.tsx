...
const PlayerCard = ({
  ...
  // const [isSelected, setIsSelected] = useState(false);   // commenting it because every time rendering , it gets back to its previous state
  // thats why i use ***Derived State*** before the handler

  // console.log(isSelected, setIsSelected, "isSelected, setIsSelected");
  console.log(coin, setCoin, "from player card");

  // Derived State
   const isSelected = selectedPlayers.some(
     (val) => val.playerName === player.playerName,
   );
  ...
  const handleSelectPlayer = () => {
    ...
    // In Navbar, update the coins for selecting a player
    ...
    } else toast.error("Coin is not enough");

    // For selected player functionality
  };
